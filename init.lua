...
-- Refactored Monzo read-only autocommands
local monzo_readonly_patterns = {
  '$GOPATH/src/github.com/monzo/wearedev/vendor/*',
  '$GOPATH/src/github.com/monzo/wearedev/{service,cron}.*/manifests/*-template.{yml,yaml}',
  '$GOPATH/src/github.com/monzo/wearedev/{service,cron}.*/proto/*.{firehose.go,pb.go,proto.desc,router.go,streams.go,typhon.go,validator.go}',
  '$GOPATH/src/github.com/monzo/wearedev/service.*/crons/crons.json',
  '$GOPATH/src/github.com/monzo/wearedev/CODEOWNERS',
}

vim.api.nvim_create_autocmd(events, {
  group = monzo_group,
  pattern = monzo_readonly_patterns,
...
-- Telescope
-- Most Telescope keymaps are defined in lua/custom/plugins/configs/telescope.lua
vim.api.nvim_set_keymap('n', '<leader>b', ":lua require('lua/custom/telescope').my_buffer()<cr>", { noremap = true, desc = 'Search Buffers (Custom)' })

-- Diagnostics
vim.keymap.set('n', '<leader>q', vim.diagnostic.setloclist, { desc = 'Open diagnostic [Q]uickfix list' })

-- ToggleTerm
-- Keymap <space>td is defined in the plugin's config function in lua/plugins/configs/toggleterm.lua (if it were moved there)
-- For now, it's defined within its setup block in this file.

-- MiniFiles
-- Keymap for <leader>~ to open MiniFiles is defined further down, near where 'mini.files' is required.

-- Conform (Formatter)
-- Keymap <leader>f for formatting is defined in the conform.nvim plugin setup.
...
require('lazy').setup({
  ...
  -- MiniFiles Keymap (belongs to Plugin Keymaps but placed here due to lazy loading context)
